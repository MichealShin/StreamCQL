 ...
 *
 */
public class EventTimeSlideWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new EventTimeSlideWindowCreator();
    ...
    {
        return Window.createEventTimeSlideWindow(ConstInTestCase.I_1000, "t");
    }
