 ...
 *
 */
public class SubSelectClauseParseTest
{
    
    private static final Logger LOG = LoggerFactory.getLogger(SubSelectClauseParseTest.class);
    
    /**
     * 最基本的文件路径
     */
    private static final String BASICPATH = File.separator + "parser" + File.separator;
    ...
    public void testExpressions()
        throws Exception
    {
        executeCase(ParserFactory.createApplicationParser(), "expressions");
    }
    ...
    public void testWhereClause()
        throws Exception
    {
        executeCase(ParserFactory.createApplicationParser(), "whereClause");
    }
    ...
    public void testprevious()
        throws Exception
    {
        executeCase(ParserFactory.createApplicationParser(), "previous");
    }
    ...
    public void testCombine()
        throws Exception
    {
        executeCase(ParserFactory.createApplicationParser(), "combine");
    }
    ...
    private void executeCase(IParser parser, String caseName)
        throws Exception
    {
        long startTime = System.currentTimeMillis();
        ParseTaskUtil qt =
            new ParseTaskUtil(parser, inPutDir + caseName + CQLTestCommons.INPUT_POSTFIX, outPutDir + caseName
                + CQLTestCommons.OUTPUT_POSTFIX, resultPutDir + caseName + CQLTestCommons.RESULT_POSTFIX);
        try
        {
