 ...
 *
 */
public class EventTimeBatchWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new EventTimeBatchWindowCreator();
    ...
    {
        return Window.createEventTimeBatchWindow(ConstInTestCase.I_1000, "t");
    }
