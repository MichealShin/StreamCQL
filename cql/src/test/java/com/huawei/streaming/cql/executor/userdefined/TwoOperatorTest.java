...
public class TwoOperatorTest
{
    ...
    public void writerTest()
        throws Exception
    {
        String serOutFileName = "twoOperator.out.xml";
        String serResultFileName = "twoOperator.res.xml";
    ...
    private static Operator createOutputStream()
    {
        ...
        operator.setArgs(config);
        operator.setRecordWriterClassName(WebFilterOutputStream.class.getName());
        return operator;
    }
    ...
    private static List<OperatorTransition> createTransitions(List<Operator> ops, List<Schema> schemas)
    {
        ...
        results.add(new OperatorTransition("inputStream", ops.get(ConstInTestCase.I_0), ops.get(ConstInTestCase.I_1),
