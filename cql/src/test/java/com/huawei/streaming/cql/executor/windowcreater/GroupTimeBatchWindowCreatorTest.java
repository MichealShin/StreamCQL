...
/**
 * group time batch window test case
 *
 */
public class GroupTimeBatchWindowCreatorTest
{
    /**
     * 测试用例
     *
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new GroupTimeBatchWindowCreator();
    ...
    {
        return Window.createGroupTimeBatchWindow(1, "id");
    }
