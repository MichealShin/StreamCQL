...
/**
 * create length sort window test case
 *
 */
public class LengthSortWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new LengthSortWindowCreator();
    ...
    {
        return Window.createLengthSortWindow(1, "id desc");
    }
