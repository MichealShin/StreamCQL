...
/**
 * 创建group length batchwindow实例
 *
 */
public class GroupLengthBatchWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new GroupLengthBatchWindowCreator();
    ...
    {
        return Window.createGroupLengthBatchWindow(1, "id");
    }
