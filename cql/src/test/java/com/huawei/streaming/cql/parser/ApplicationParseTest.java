 ...
 * DDL类型的CQL语句测试用例
 * <p/>
 * 所有的测试用例都分布在不同的文件中，一个文件包含多条CQL语句
 * 这里的测试用例，都是正常用例
 *
 */
public class ApplicationParseTest
{
    private static final Logger LOG = LoggerFactory.getLogger(ApplicationParseTest.class);
    ...
    public void testCreateOutputStream()
        throws Exception
    {
        executeCase("createOutput");
    }
    
    /**
     * create pipestream 的测试类
     *
     */
    @Test
     ...
     */
    @Test
    public void testCommonds()
        throws Exception
    {
        executeCase("commonds");
    }
     ...
     */
    @Test
    public void testCreateUserOperator()
        throws Exception
    {
        executeCase("createUserOperator");
    }
     ...
     */
    @Test
    public void testInsertUserOperator()
        throws Exception
    {
        executeCase("insertUserOperator");
    }
