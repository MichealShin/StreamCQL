...
/**
 * 创建group length window测试用例
 *
 */
public class GroupLengthSlideWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new GroupLengthSlideWindowCreator();
    ...
    {
        return Window.createGroupLengthSlideWindow(1, "id");
    }
