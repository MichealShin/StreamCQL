 ...
 *
 */
public class NaturalDaySlideWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new NaturalDaySlideWindowCreator();
    ...
    {
        Window w = Window.createEventTimeBatchWindow(ConstInTestCase.I_1000, "t");
        w.setName(WindowCommons.TODAY_WINDOW);
        return w;
    }
