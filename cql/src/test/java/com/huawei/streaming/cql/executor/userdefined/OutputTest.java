...
/**
 * 用户自定义输出算子测试，使用api中的outputStream算子
 *
 */
public class OutputTest
{
        ...
        throws Exception
    {
        ...
        String serOutFileName = "output.out.xml";
        String serResultFileName = "output.res.xml";
    ...
    {
        OutputStreamOperator output = new OutputStreamOperator("output", 1);
        output.setRecordWriterClassName(ConsolePrintOutput.class.getName());
        output.setSerializerClassName(SimpleSerDe.class.getName());
        return output;
    }
