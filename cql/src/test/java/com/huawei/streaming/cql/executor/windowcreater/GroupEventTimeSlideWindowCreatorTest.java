...
/**
 * group by event time slide window 测试
 *
 */
public class GroupEventTimeSlideWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new GroupEventTimeSlideWindowCreator();
    ...
    {
        return Window.createGroupEventTimeSlideWindow(ConstInTestCase.I_1000, "id", "t");
    }
