 ...
 *
 */
public class GroupEventTimeBatchWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new GroupEventTimeBatchWindowCreator();
    ...
    {
        return Window.createGroupEventTimeBatchWindow(ConstInTestCase.I_1000, "id", "t");
    }
