...
/**
 * <EventTimeSlideWindowTest>
 * <功能详细描述>
 * 
 */
public class EventTimeSlideWindowTest
{
    private EventTimeSlideWindow myView = null;
    ...
    /**
     * Test EventTimeSlideWindow(long, IExpression).
     */
    @Test
    public void testEventTimeSlideWindow()
    {
        try
        {
            myView = new EventTimeSlideWindow(0, null);
            fail();
        }
        ...
        try
        {
            myView = new EventTimeSlideWindow(-1, null);
            fail();
        }
        catch (IllegalArgumentException e)
        {
        ...
        try
        {
            myView = new EventTimeSlideWindow(1, new PropertyValueExpression("timestamp", Boolean.class));
            fail();
        }
        catch (IllegalArgumentException e)
        {
        ...
        try
        {
            myView = new EventTimeSlideWindow(1, new PropertyValueExpression("timestamp", String.class));
            fail();
        }
        catch (IllegalArgumentException e)
        {
        ...
        try
        {
            myView = new EventTimeSlideWindow(1, new PropertyValueExpression("timestamp", Long.class));
            myView = new EventTimeSlideWindow(1, new PropertyValueExpression("timestamp", Integer.class));
            myView = new EventTimeSlideWindow(1, new PropertyValueExpression("timestamp", Double.class));
            myView = new EventTimeSlideWindow(1, new PropertyValueExpression("timestamp", Float.class));
            myView = new EventTimeSlideWindow(1, new PropertyValueExpression("timestamp", Date.class));
            myView = new EventTimeSlideWindow(1, new PropertyValueExpression("timestamp", Timestamp.class));
            Assert.assertTrue(true);
        }
        catch (IllegalArgumentException e)
        { 
    ...
    {
        myView = new EventTimeSlideWindow(SupportConst.I_FIVE, new PropertyValueExpression("timestamp", Long.class));
        ...
        SupportViewDataCheck.checkNewData(childView, new IEvent[] {event2, event3, event4, event5, event6});
    }
    ...
    {
        myView = new EventTimeSlideWindow(SupportConst.I_FIVE, new PropertyValueExpression("timestamp", Timestamp.class));
        myView.addView(childView);
    ...
    public void testRenewView()
    {
        ...
        myView = new EventTimeSlideWindow(SupportConst.I_FIVE, timeExpr);
        
        IView renewView = myView.renewView();
        Assert.assertEquals(true, renewView instanceof EventTimeSlideWindow);
        Assert.assertEquals(SupportConst.I_FIVE, ((EventTimeSlideWindow)renewView).getKeepTime());
        Assert.assertEquals(timeExpr, ((EventTimeSlideWindow)renewView).getTimeExpr());
    }
