...
/**
 * <GroupTimeSlideWindowTest>
 * <功能详细描述>
 * 
 */
public class GroupTimeSlideWindowTest
{
    
    private static final int OFFSET = 600;
    
    private static final long SLIDE_INTERVAL = 5;
    
    private IExpression[] exprs = null;
    
    private GroupTimeSlideWindow myView = null;
        ...
        throws Exception
    {
        ...
        myView = new GroupTimeSlideWindow(exprs, SupportConst.BATCH_TIME, SLIDE_INTERVAL);
    ...
    public void testGroupTimeBatchWindow()
    {
        try
        {
            myView = new GroupTimeSlideWindow(null, SupportConst.I_FIVE, SLIDE_INTERVAL);
            fail();
        }
        ...
        try
        {
            myView = new GroupTimeSlideWindow(new IExpression[] {}, SupportConst.I_FIVE, SLIDE_INTERVAL);
            fail();
        }
        catch (IllegalArgumentException e)
        {
        ...
        try
        {
            myView = new GroupTimeSlideWindow(new IExpression[] {}, SupportConst.I_ZERO, SLIDE_INTERVAL);
            fail();
        }
        catch (IllegalArgumentException e)
        {
        ...
        {
            myView =
                new GroupTimeSlideWindow(new IExpression[] {new PropertyValueExpression("a", Integer.class)},
                    SupportConst.I_ZERO, SLIDE_INTERVAL);
            fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void testTimerCallBack()
    {
        ...
        myView.timerCallBack(System.currentTimeMillis() + OFFSET);
        SupportGroupViewDataCheck.checkOldData(1, childView, new IEvent[] {event13});
        SupportGroupViewDataCheck.checkNewData(1, childView, null);
